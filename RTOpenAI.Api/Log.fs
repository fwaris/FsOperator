...
module Log =     
        let getLogger() : ILogger<RTOpenAILog>  = Unchecked.defaultof<_> //IPlatformApplication.Current.Services.GetService(typeof<ILogger<RTOpenAILog>>)  :?> ILogger<RTOpenAILog>      
